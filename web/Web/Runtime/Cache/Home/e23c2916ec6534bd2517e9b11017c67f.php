...
<head>
    ...
    <link href="/Public/Home/css/contact.css" rel="stylesheet" type="text/css"/>
...
<div id="header">
    ...
    <div class="main">
        <div class="main-content">
            <div class="left"><img src="/Public/Home/images/about.png" alt="加粉助手" class="mobile"></div>
            <div class="right">
                <div class="subtitle"><img src="/Public/Home/images/cop.png" alt="欢迎咨询合作"
                                           class="slogan"></div>
                <div class="download-wrap">
                    <div class="barcode"><img src="/Public/Home/images/qrcode.png" alt="二维码下载"></div>
                    <div class="download-list">
                        <a target="_blank" href="#" class="download-item false">QQ在线咨询</a>
                        <a target="_blank" href="#" class="download-item false">QQ群1</a>
                        <a target="_blank" href="#" class="download-item false">QQ群2</a>
                    </div>
