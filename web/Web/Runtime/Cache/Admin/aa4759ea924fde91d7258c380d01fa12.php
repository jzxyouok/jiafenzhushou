...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/Admin/uploader/upload.css" />
...
<div class="wrapper">
    ...
    <section class="content-header">
        <h1>
            文章
            <small><a href="<?php echo U('Admin/News/index');?>">文章管理</a></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="/"><i class="fa fa-dashboard"></i>首页</a></li>
            <li><a href="<?php echo U('Admin/News/index');?>">文章管理</a></li>
                                ...
                                <div class="form-group col-xs-6">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="cat_name" name="title" class="form-control"
                                               placeholder="文章标题" required="required" value="<?php echo ($news["title"]); ?>"
                                ...
                                <div class="form-group col-xs-6">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea id="description" name="description" maxlength="120"
                                                  ...
                                                  data-parsley-trigger="blur change"><?php echo ($news["description"]); ?></textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="add-pic">
                                            <div id="thumb" class="add-pic-imgbox">
                                                <?php if(!empty($news["thumb"])): ?><div class='add-pic-after add-file-after'><img
                                                            style='width:100%;height:100%' src='/<?php echo ($news["thumb"]); ?>'>
                                                        <div class='operation'>
                                                            <div class='bg'></div>
                                                            <ul class='fun'>
                                                                <li><a title='查看原图' class='magnifier' target='_blank'
                                                                       href='/<?php echo ($news["thumb"]); ?>'><b>查看原图</b></a>
                                                                </li>
                                                                <li><a title='替换'
                                                        ...
                                                        <input type='hidden' value='<?php echo ($news["thumb"]); ?>'
                                                               name='thumb'></div>
                                            ...
                                            <div class="add-pic-rule">
                                                <ul class="add-pic-rule-list">
                                                    <li>
                                                        160*120，大小200K以内，JPG、PNG格式，建议使用直角图标
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-xs-12">
                                        <div class="col-sm-12">
                                            <script id="content" name="content" type="text/plain"
                                                    style="width:100%;min-height:300px"><?php echo htmlspecialchars_decode($news['content']);?>
                                            </script>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript" src="/Public/Admin/vendor/zeroclipboard/ZeroClipboard.min.js"></script>
    ...
    <script type="text/javascript" src="/Public/Admin/vendor/webuploader/webuploader.withoutimage.min.js"></script>
    <script type="text/javascript" src="/Public/Admin/uploader/upload.js"></script>
    <script type="text/javascript" src="/Public/Admin/vendor/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" src="/Public/Admin/vendor/ueditor/ueditor.all.js"></script>
    <script type="text/javascript" src="/Public/Admin/vendor/ueditor/lang/zh-cn/zh-cn.js"></script>
