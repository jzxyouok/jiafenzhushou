            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <form action="<?php echo U();?>" method="POST">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <input type="text" name="title" class="form-control pull-right" placeholder="关键词">
                        ...
                        <i class=""></i>
                        <a href="<?php echo U('Admin/News/add');?>">
                                    ...
                                    <table id="list" class="table table-bordered table-striped dataTable" role="grid"
                                        ...
                                        <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr role="row" class="  <?php if(($mod) == "2"): ?>odd<?php else: ?>even<?php endif; ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <?php if(($item["status"]) == "1"): ?><a href="<?php echo U('Admin/News/changeStatus?method=forbid&news_id='.$item['news_id']);?>"
                                                        ...
                                                        <?php else: ?>
                                                        <a href="<?php echo U('Admin/News/changeStatus?method=resume&news_id='.$item['news_id']);?>"
                                                    ...
                                                    <a href="<?php echo U('Admin/News/changeStatus?method=delete&news_id='.$item['news_id']);?>"
                                                ...
                                                <td>  <a href="<?php echo U('Admin/News/edit?&news_id='.$item['news_id']);?>"
                                                         class="table-link">
