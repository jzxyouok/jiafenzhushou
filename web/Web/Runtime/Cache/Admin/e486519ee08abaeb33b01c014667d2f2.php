...
<div class="wrapper">
    ...
    <section class="content-header">
        <h1>
            订单
            <small><a href="<?php echo U('Admin/Order/index');?>">订单管理</a></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="/"><i class="fa fa-dashboard"></i>首页</a></li>
            <li><a href="<?php echo U('Admin/Order/index');?>">订单管理</a></li>
                                ...
                                <div class="col-sm-12">
                                    <table id="list" class="table table-bordered table-striped dataTable" role="grid"
                                        ...
                                        <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr role="row" class="  <?php if(($mod) == "2"): ?>odd<?php else: ?>even<?php endif; ?>">
                                                ...
                                                <td><?php echo ($item["decode"]); ?></td>
                                                <td><?php echo ($item['money']); ?></td>
                                                <td><?php echo date('Y-m-d
                                                    H:i:s',$item['update_time']);?>
                                                </td>
                                                <td><?php $paystatus = array( '-1' => 'label-danger', '0' => 'label-warning', '1' => 'label-success', ); $paystatusText = array( '0' => '未付款', '1' => '已付款', ); ?>
                                                <span
                                                        class="label label-sm  <?php echo ($paystatus[$item['pay_status']]); ?>"><?php echo ($paystatusText[$item['pay_status']]); ?></span>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if(($item["status"]) == "1"): ?><a href="<?php echo U('Admin/Order/changeStatus?method=forbid&order_id='.$item['order_id']);?>"
                                                        ...
                                                        <?php else: ?>
                                                        <a href="<?php echo U('Admin/Order/changeStatus?method=resume&order_id='.$item['order_id']);?>"
                                                    ...
                                                    <a href="<?php echo U('Admin/Order/changeStatus?method=delete&order_id='.$item['order_id']);?>"
