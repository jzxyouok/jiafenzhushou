...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/vendor/datatables/dataTables.bootstrap.css" />
                        ...
                        <div class="box-tools">
                            <form action="<?php echo U();?>" method="POST">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    ...
                                    <input type="text" name="username" class="form-control pull-right" placeholder="关键词">
                                    ...
                                    <table id="list" class="table table-bordered table-striped dataTable" role="grid"
                                        ...
                                        <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr role="row" class="  <?php if(($mod) == "2"): ?>odd<?php else: ?>even<?php endif; ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <?php if(($item["status"]) == "1"): ?><a href="<?php echo U('Admin/Admin/changeStatus?method=forbid&admin_id='.$item['admin_id']);?>"
                                                        ...
                                                        <?php else: ?>
                                                        <a href="<?php echo U('Admin/Admin/changeStatus?method=resume&admin_id='.$item['admin_id']);?>"
                                                    ...
                                                    <a href="<?php echo U('Admin/Admin/edit?&admin_id='.$item['admin_id']);?>"
                                                       class="table-link">
                                                    <span class="fa-stack"> <i class="fa fa-square fa-stack-2x"></i>
                                                        <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
									                </span>
                                                    </a>
                                                    <a href="<?php echo U('Admin/Admin/changeStatus?method=delete&admin_id='.$item['admin_id']);?>"
...
<script type="text/javascript" src="/Public/Admin/vendor/zeroclipboard/ZeroClipboard.min.js"></script>
    ...
    <script type="text/javascript" src="/Public/vendor/datatables/jquery.dataTables.min.js"></script>
    <script type="text/javascript" src="/Public/vendor/datatables/dataTables.bootstrap.min.js"></script>
